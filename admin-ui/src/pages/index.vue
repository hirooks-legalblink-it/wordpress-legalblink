...
<!--          <v-img
            ...
            <v-card-title class="pa-0 text-h5 text-wrap mb-4">
              Il generatore di documenti legali sviluppato da avvocati specializzati nel digitale
            </v-card-title>
            <p class="pa-0 text-body-1 mb-2">
              Una soluzione completa per generare i documenti legali del tuo sito in modo semplice, conveniente e con tutte le funzionalità necessarie.
            </p>
            <p class="pa-0 text-body-1">
              Genera e personalizza condizioni di vendita, privacy, cookie policy e banner cookie con facilità, grazie a un'assistenza clienti di alto livello e alla possibilità di ricevere configurazioni curate direttamente dal nostro team legale.
            </p>
          </v-card-text>
        </v-card>
...
<script lang="ts" setup>
  ...
  const allTabs = [
    ...
    { label: 'Informativa privacy', value: 'privacy_policy' },
    { label: 'Termini del sito', value: 'terms_of_service' },
