        ...
        <v-col class="pb-0" cols="12">
          <div class="d-flex align-center">
            ...
            <v-tooltip contained max-width="400">
              ...
              <template v-if="policyType === 'privacy_policy'" #default>
                È il link al documento della privacy policy generato da LegalBlink. <br>
                Il sistema utilizzerà automaticamente questo documento per mostrarne i contenuti nella pagina scelta.
              </template>
              <template v-else-if="policyType === 'cookie_policy'" #default>
                È il link al documento della cookie policy generato da LegalBlink. <br>
                Il sistema utilizzerà automaticamente questo documento per mostrarne i contenuti nella pagina scelta.
              </template>
              <template v-else-if="policyType === 'terms_of_service'" #default>
                È il link al documento dell'informativa sulle Condizioni Generali di Vendita generato da LegalBlink. <br>
                Il sistema utilizzerà automaticamente questo documento per mostrarne i contenuti nella pagina scelta.
              </template>
            </v-tooltip>
          </div>
...
<script lang="ts" setup>
  ...
  const editPagesUrl = window.wplb.editPagesUrl || '#'
