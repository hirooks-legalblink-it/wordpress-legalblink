...
<script lang="ts" setup>
  ...
  const i18n = (window as any).LB_I18N || {
    ...
    iframe_label: '<b>Per inserire l\'iframe nel tuo sito</b>, incolla questo codice nella pagina desiderata:',
    link_label: '<b>Per inserire il link</b>, incolla il questo codice nella versione HTML:',
