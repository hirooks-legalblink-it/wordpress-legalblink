...
const defaultBrandingData: BrandingData = {
  logo: '',
  colors: {
    primary: themeConf.theme.themes.legalblinkLight.colors.primary,
    error: themeConf.theme.themes.legalblinkLight.colors.error,
    success: themeConf.theme.themes.legalblinkLight.colors.success,
    background: themeConf.theme.themes.legalblinkLight.colors.background,
    textOnPrimary: themeConf.theme.themes.legalblinkLight.colors['on-surface'],
    warn: themeConf.theme.themes.legalblinkLight.colors.warning,
  },
}
