...
<script lang="ts" setup>
  ...
  /*watchEffect(() => {
    ...
    theme.themes.value.legalblinkLight.colors.primary = branding.value.colors.primary
    theme.themes.value.legalblinkLight.colors.success = branding.value.colors.success
    theme.themes.value.legalblinkLight.colors.error = branding.value.colors.error
    theme.themes.value.legalblinkLight.colors.warning = branding.value.colors.warn
    theme.themes.value.legalblinkLight.colors['on-surface'] = branding.value.colors.textOnPrimary
    theme.themes.value.legalblinkLight.colors.background = branding.value.colors.background
  })*/
