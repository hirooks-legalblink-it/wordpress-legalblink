...
if (!class_exists('WPLB_Main_API_Controller')) {
    /**
     * Main API Controller
     * Coordinates all API controllers and handles general functionality
     */
    final class WPLB_Main_API_Controller extends WPLB_Base_API_Controller
    {
        /**
        ...
        private function __construct()
        {
            ...
            $this->cache_controller = new WPLB_Cache_API_Controller();
            $this->auth_controller = new WPLB_Auth_API_Controller();
            $this->external_controller = new WPLB_External_API_Controller();
            $this->document_controller = new WPLB_Document_API_Controller();
        ...
        public function get_banner_data()
        {
            try {
                ...
                WPLB_Option_Helper::setOption('cookie_banner_html_code', $banner_snippet);

                $banner_data = array(
                    'enabled' => (bool)WPLB_Option_Helper::getOption('cookie_banner_enabled', false),
                    'html' => WPLB_Option_Helper::getOption('cookie_banner_html_code', ''),
                );

                WPLB_Logger::info('Banner data fetched and cached successfully', WPLB_Logger::CATEGORY_API, 'get_banner_data');
        ...
        public function set_banner_data($request)
        {
            ...
            // Update options
            WPLB_Option_Helper::setOption('cookie_banner_enabled', $enabled);

            // Clear cache
            $cache_key = 'banner';
            WPLB_Transient_Helper::delete($cache_key);
