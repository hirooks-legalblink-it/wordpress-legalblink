...
if (!class_exists('WPLB_Base_API_Controller')) {
    /**
     * Base API Controller
     * Contains common functionality shared across API controllers
     */
    abstract class WPLB_Base_API_Controller
    {
        /**
        ...
        {
            return WPLB_Config_Helper::get_api_namespace();
        }
        ...
        {
            return WPLB_Config_Helper::get_api_base_url();
        }
        ...
        {
            return WPLB_Config_Helper::get_api_bearer_token();
        }
        ...
        {
            return WPLB_Config_Helper::get_api_rate_limit();
        }
        ...
        {
            return WPLB_Config_Helper::get_api_cache_time();
        }
        ...
        protected function check_rate_limit()
        {
            ...
            $current_count = WPLB_Transient_Helper::get($rate_limit_key, false);

            if ($current_count === false) {
                WPLB_Transient_Helper::set($rate_limit_key, 1, MINUTE_IN_SECONDS);
                return true;
            }
            ...
            WPLB_Transient_Helper::set($rate_limit_key, $current_count + 1, MINUTE_IN_SECONDS);
            return true;
        }
